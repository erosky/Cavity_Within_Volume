...
# data: RUN TEMP
temperature_file = 'analysis/freeze_temp_fit_8layers.dat'
...
all_runs_plot = 'analysis/fits_8layer.png'

plt.figure(1)
plt.xlim(240,225)
plt.ylim(0,1.0)
plt.title('Heterogeneous freezing in Ibeam graphite capillary with 8 water layers, MLmW Model, 0.25 K/ns')
...
# plot gradients
all_gradients_plot = 'analysis/gradient_fit_8layers.png'
