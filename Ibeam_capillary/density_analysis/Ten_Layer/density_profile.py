...
N_total = 2386 # Total number of water molecules
...
zbin_edges = [10.062, 13.056, 16.05, 19.044, 22.038, 25.032, 28.026, 31.02, 34.014, 37.008]
...
for step in timesteps:
	...
	for zbin_file in os.listdir('run_5/'+str(step)):
		zbin = zbin_file[:-4]
		print (zbin)
		zbin_data = np.loadtxt('run_5/'+str(step)+'/'+zbin_file)
...
output = open('average_profile.dat', 'w')
for d in zbin_edges:
	output.write(str(d)+'\t')
output.write('\n')
