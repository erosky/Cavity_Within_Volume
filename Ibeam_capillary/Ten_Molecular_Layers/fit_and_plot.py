...
# data: RUN TEMP
temperature_file = 'analysis/freeze_temp_fit_10layers.dat'
...
all_runs_plot = 'analysis/fits_10layer.png'

plt.figure(1)
plt.xlim(235,225)
plt.ylim(0,1.0)
plt.title('Heterogeneous freezing in Ibeam graphite capillary with 10 water layers, MLmW Model, 0.25 K/ns')
...
# plot gradients
all_gradients_plot = 'analysis/gradient_fit_10layers.png'
