...
# data: RUN TEMP
temperature_file = 'analysis/freeze_temp_fit_10layers_extrawide_240K.dat'
...
all_runs_plot = 'analysis/fits_10layer_240K.png'

plt.figure(1)
plt.xlim(240,227)
plt.ylim(0,1.0)
plt.title('Heterogeneous freezing in extra wide Ibeam capillary, 10 water layers, MLmW Model, 0.25 K/ns')
...
# plot gradients
all_gradients_plot = 'analysis/gradient_fit_10layers_240K.png'

plt.figure(2)
plt.xlim(240,227)
plt.title('Heterogeneous freezing in wide Ibeam capillary, 10 water layers, MLmW Model, 0.25 K/ns')
plt.xlabel('Temperature (K)')
