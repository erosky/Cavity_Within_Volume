...
BEGIN { YBIN = 69.9338 ;
	...
	ZTOP = 37.5 ;
	ZBOTTOM = 12 ;
	YBIN_WIDTH = 3.0406 ; XMIN_TOP = 9999 ; XMAX_TOP = -9999 ; XMIN_BOT = 9999 ; XMAX_BOT = -9999 ; start = 0 } 
{
	if ($2=="TIMESTEP") {
		if (start==1) { 
			print step*0.00001 "\t" 235-step*0.25*0.00001 "\t" YBIN "\t" XMIN_TOP "\t" XMAX_TOP "\t" XMIN_BOT "\t" XMAX_BOT "\t" (XMAX_TOP-XMIN_TOP)*YBIN_WIDTH "\t" (XMAX_BOT-XMIN_BOT)*YBIN_WIDTH "\t" (XMAX_TOP-XMIN_TOP)*YBIN_WIDTH+(XMAX_BOT-XMIN_BOT)*YBIN_WIDTH ; exit } ; 
