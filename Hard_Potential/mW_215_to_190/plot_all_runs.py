...
# data: RUN TEMP
temperature_file = 'analysis/freeze_temperatures_hardcavity_mW.dat'
...
all_runs_plot = 'analysis/all_runs_hardcavity_mW.png'
...
# plot gradients
all_gradients_plot = 'analysis/all_gradients_hardcavity_mW.png'
